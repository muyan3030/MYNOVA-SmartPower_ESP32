...
Settings::Settings()
{
    ...
    AC_PowerON = false;
    MQTT_IP = "192.168.123.241";        // MQTT_IP
    MQTT_USER = "";       // MQTT_USER
    MQTT_PSW = "";        // MQTT_PSW
}
...
void Settings::ReadSettings()
{
    ...
    enable_MQTT =   prefs.getBool("ENABLE_MQTT", true);
    ...
    MQTT_IP =       prefs.getString("MQTT_IP", "192.168.123.241");
    MQTT_USER =   prefs.getString("MQTT_USER", "");
    MQTT_PSW =   prefs.getString("MQTT_PSW", "");
...
void Settings::SaveSettings()
{
    ...
    prefs.putBool("ENABLE_MQTT", enable_MQTT);
    ...
    prefs.putString("MQTT_IP", MQTT_IP);
    prefs.putString("MQTT_USER", MQTT_USER);
    prefs.putString("MQTT_PSW", MQTT_PSW);
